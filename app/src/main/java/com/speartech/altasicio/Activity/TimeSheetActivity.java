...
public class TimeSheetActivity extends AppCompatActivity {
    ...
    public static RelativeLayout back, search, add_timesheet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_timesheet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TimeSheetActivity.this, AddTimesheetActivity.class);
    ...
    public void initilze(){
        ...
        add_timesheet = (RelativeLayout) findViewById(R.id.add_timesheet);
